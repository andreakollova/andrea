          ...
          <div className="flex items-center gap-4">
            {section.headerImage && (
              <picture>
                ...
                <img src={section.headerImage} alt="Andrea Kollova" className="w-14 h-14 rounded-full object-cover flex-shrink-0 cursor-pointer hover:opacity-90 transition-opacity" onClick={() => setLightboxSrc(section.headerImage!)} />
              </picture>
            )}
